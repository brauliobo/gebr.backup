...
gebrme_quit(void)
{
	...
	g_object_unref(gebrme.actions.menu.open);
	g_object_unref(gebrme.actions.menu.save);
	g_object_unref(gebrme.actions.menu.save_as);
	g_object_unref(gebrme.actions.menu.revert);
	g_object_unref(gebrme.actions.menu.delete);
	g_object_unref(gebrme.actions.menu.close);
	g_object_unref(gebrme.actions.program.new);
	g_object_unref(gebrme.actions.program.delete);
	g_object_unref(gebrme.actions.parameter.new);
	g_object_unref(gebrme.actions.parameter.delete);
